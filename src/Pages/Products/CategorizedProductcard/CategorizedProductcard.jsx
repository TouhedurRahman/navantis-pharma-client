...
const CategorizedProductcard = ({ product }) => {
    return (
        <Link to={`/products/${product.category}/${product._id}`}>
            <div className="w-full bg-base-100 hover:text-gray-700 border-2 shadow-xl hover:shadow-gray-700">
                ...
                <div className="w-full flex justify-center items-center mt-3 bg-gray-700 text-white">
