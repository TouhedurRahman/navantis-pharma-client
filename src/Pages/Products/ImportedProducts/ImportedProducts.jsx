                    ...
                    <div className=''>
                        <div className='flex justify-center lg:justify-end items-center text-3xl font-sans font-bold mb-5'>
                            ...
                            <div className='tooltip'>
                                <MdViewList
                                    className={`ml-2 cursor-pointer ${gridView === false ? 'text-[#FB923C]' : 'text-[#0B5F82]'}`}
                            ...
                            <div className='tooltip'>
                                <MdGridView
                                    className={`ml-2 cursor-pointer ${gridView === true ? 'text-[#FB923C]' : 'text-[#0B5F82]'}`}
