                    ...
                    <div className="flex justify-end items-center">
                        <div>
                            <ul className="menu-horizontal z-10">
                                <li>
                                    <Link to='/products' className={`mx-3 ${isScrolled && 'hover:text-gray-700'} inline-block ${location.pathname === '/products' ? 'text-gray-700 font-bold border-b-2 border-gray-700' : ''}`}>PRODUCTS</Link>
                                </li>
                                <li>
                                    <Link to='/our-partner' className={`mx-3 ${isScrolled && 'hover:text-gray-700'} inline-block ${location.pathname === '/our-partner' ? 'text-gray-700 font-bold border-b-2 border-gray-700' : ''}`}>PARTNER</Link>
                                </li>
                                <li>
                                    <Link to='/news-room' className={`mx-3 ${isScrolled && 'hover:text-gray-700'} inline-block ${location.pathname === '/news-room' ? 'text-gray-700 font-bold border-b-2 border-gray-700' : ''}`}>NEWS ROOM</Link>
                                </li>
                                <li>
                                    <Link to='/careers' className={`mx-3 ${isScrolled && 'hover:text-gray-700'} inline-block ${location.pathname === '/careers' ? 'text-gray-700 font-bold border-b-2 border-gray-700' : ''}`}>CAREERS</Link>
                                </li>
                                <li>
                                    <Link to='/contact-us' className={`mx-3 ${isScrolled && 'hover:text-gray-700'} inline-block ${location.pathname === '/contact-us' ? 'text-gray-700 font-bold border-b-2 border-gray-700' : ''}`}>CONTACT US</Link>
                                </li>
                            </ul>
                        </div>
                        <div
