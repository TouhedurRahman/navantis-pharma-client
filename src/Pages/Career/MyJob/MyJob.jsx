...
const MyJob = () => {
    ...
    const onSubmit = data => {
        ...
        Swal.fire({
            ...
            /* Data Saved to DB*/
            axios.post('https://api.navantispharma.com/applications', newApplication)
                .then(data => {
                            ...
                            <div className='w-full lg:w-1/2 p-2 lg:ml-10 border-2 shadow-lg px-3 rounded-lg'>
                                ...
                                <div className='mx-3'>
                                    ...
                                    {errors.resume && <p className='text-red-600 font-mono font-thin'>{errors.resume.message}</p>}
                                        ...
                                        <button
                                            type="submit"
                                            className='w-36 h-12 my-10 border-2 border-gray-700 text-black text-xl hover:bg-gray-700 hover:text-white font-bold py-2 px-4 rounded'
                                        >
                                            Submit
                                        </button>
                                    </form>
